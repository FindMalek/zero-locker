...
// Simple CodeBlock component for MDX usage
export type SimpleCodeBlockProps = HTMLAttributes<HTMLDivElement> & {
  language?: string;
  filename?: string;
  code?: string;
  children?: string;
...
export const CodeBlockCopyButton = ({
  ...
  const contextCode = data.find((item) => item.language === value)?.code;
  const code = directCode || contextCode;
