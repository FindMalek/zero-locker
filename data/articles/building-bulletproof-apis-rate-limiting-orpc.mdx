...
Ever had your API get hammered by a bot or someone trying to spam your endpoints? Yeah, we've all been there. Let's fix that with some solid rate limiting for your [oRPC](https://orpc.dev) APIs.
...
<CodeBlock 
  language="typescript"
  title="lib/utils/rate-limit.ts - Basic Types"
...
<CodeBlock 
  language="typescript"
  title="Core Rate Limiting Function"
...
<CodeBlock 
  language="typescript"
  title="middleware/rate-limit.ts"
